...
Среднее, полученное методом бутстрепа, с высокой точностью близко к grand_mean, однако полученный доверительный интервал [0.004039357, 0.009230911] покрывает лишь 3 главы из 11, что кажется плохим результатом. 
